package com.elaneri.quantumrandom;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String defaultRandom = getResources().getString(R.string.defRrandomnumsShare);
                String randomNums = sharedPref.getString(getString(R.string.randomnums), defaultRandom);

                Intent sendIntent = new Intent();
                sendIntent.setAction(Intent.ACTION_SEND);
                sendIntent.putExtra(Intent.EXTRA_TEXT, randomNums);
